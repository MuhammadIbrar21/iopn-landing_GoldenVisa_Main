      ...
      <div className="flex w-full flex-col items-center bg-white-0">
        <div className="self-stretch">
                ...
                <div className="mx-52 flex flex-col items-center gap-12 max-[1050px]:mx-0">
                  <div className="flex flex-col items-center gap-[30px] self-stretch">
                    ...
                    <Text
                      ...
                      as="p"
                      className="text-shadow-ts1 !text-white-0 text-center max-[1440px]:text-[46px]"
                    >
                      <>
                        Unlock Your Future
                        <br />
          ...
          <div className="relative h-[1046px]">
            <div className="absolute bottom-0 left-0 right-0 top-0 m-auto h-max flex-1 bg-gradient2 py-[100px] max-[1440px]:py-8 max-[1050px]:py-5 max-[550px]:py-4">
