    ...
    <>
      ...
      <div className="mt-[148px] flex justify-center self-stretch">
        <div className="container-xs flex justify-center gap-4 max-[1440px]:px-5 max-[1050px]:flex-col max-[1050px]:px-5">
          ...
          />
          <div className="flex flex-1 flex-col items-center gap-10 rounded-[20px] border border-solid border-gray-300 bg-white-0 p-7 shadow-sm max-[1050px]:self-stretch max-[550px]:p-4">
