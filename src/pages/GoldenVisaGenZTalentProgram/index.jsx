    ...
    <>
      ...
      <div className="flex w-full flex-col items-center bg-white-0">
        <div className="self-stretch">
          <div className="flex h-[1000px] items-start justify-center bg-[url(/public/images/img_hero_genz.png)] bg-cover bg-no-repeat py-4 max-[1440px]:h-auto max-[1050px]:h-auto max-[550px]:bg-[length:250%_100%] max-[550px]:bg-center max-[1050px]:bg-center">
                ...
                <div className="mx-[152px] flex flex-col items-center gap-12 max-[1050px]:mx-0">
                  <div className="flex flex-col items-center gap-[30px] self-stretch">
                    <Button
                      ...
                      className="min-w-[218px] rounded-[18px] font-medium uppercase"
                    >
                      GenZ Talent Program
                    </Button>
                    <Text
                      ...
                      as="p"
                      className="text-shadow-ts text-center !text-white-0 max-[1440px]:text-[38px] max-[550px]:text-4xl"
                    >
                      <>
                        Welcome to the UAE
                        <br />
                  ...
                  <Button
                    ...
                    rightIcon={
                      <div className="flex h-[36px] w-[36px] items-center justify-center rounded-[50%] bg-dark-0">
                        <Img
                          src="images/img_arrowleft_white_0 copy.svg"
                          alt="Arrow Left"
                          className="h-[18px] w-[18px]"
                        />
                      </div>
                    }
                    className="min-w-[258px] gap-4 font-medium capitalize !text-dark-0"
                  >
                    Enter the Draw now
                  </Button>
                </div>
        ...
        <div className="container-xs mt-[118px] max-[1440px]:px-5 max-[1050px]:px-5">
          <div className="flex gap-4 max-[1050px]:flex-col">
            <div className="relative h-[470px] w-full rounded-[20px] bg-light_base">
              <div className="absolute right-0 top-[10%] my-auto ml-12 mr-auto flex flex-1 flex-col items-start gap-6 max-[1440px]:ml-0 max-[1050px]:left-0 max-[1050px]:ml-4">
                <Button
                  size="sm"
                  color="undefined_undefined"
              ...
              <div className="mb-1.5 flex flex-col gap-4 ">
                  ...
                  suffix={
                    <div className="flex h-[36px] w-[36px] items-center justify-center rounded-[50%] bg-dark-0">
                      <Img
                        ...
                        alt="Arrow Left"
                        className="h-[28px] w-[18px]"
                      />
                    </div>
                  }
                  className="gap-4 !rounded-[34px] !text-white-1 shadow-xl max-[550px]:text-[14px]"
                />
                <div className="flex flex-col gap-3">
                  <Button
                    ...
                    className="gap-[34px] self-stretch font-medium capitalize text-white-0"
                  >
                    Generate referral link
                  </Button>
                  <Text
